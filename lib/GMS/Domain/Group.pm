...
has _dbic_group_row => (
    is      => 'ro',
    isa     => 'DBIx::Class::Row',
    handles => [ qw (id group_name submitted verify_auto active_change url deleted status group_type verify_url verify_token verify_dns verify_freetext last_change) ]
);
