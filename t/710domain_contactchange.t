...
my $ns = GMS::Domain::ContactChange->new ($mockSession, $mockSchema);
is $ns->changed_by, 'Test account', 'Retrieving a GMS::Domain::Account object for changed_by works';
is $ns->contact, 'Test contact', 'Retrieving a GMS::Domain::Contact object for contact works';
...
throws_ok {
    GMS::Domain::ContactChange->new ($mockSession, $mockSchema);
