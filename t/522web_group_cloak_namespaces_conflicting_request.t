...
$ua->content_contains("Successfully submitted the cloak namespace change request. Please wait for staff to approve the change", "Updating the namespace works");
